...
label_select_addons.place(relx=0.06, rely=0.3, anchor=CENTER)

toppings=[]
toppings_dropdown = ttk.Combobox(root, state="readonly", values = toppings)
toppings_dropdown.place(relx=0.08, rely=0.5, anchor=CENTER)

dish_amount = Label(root, font=("times", 40, "bold"))
...
btn_addons.place(relx=0.2, rely = 0.3, anchor = CENTER)
